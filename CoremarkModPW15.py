...
FLAGS = flags.FLAGS
flags.DEFINE_string('test_type', None, 'How to run the test')
FLAGS.test_type = ('vm', 'container')
...
def Prepare(benchmark_spec, FLAGS):
  ...
  if FLAGS.test_type == 'container':
      vm.Install('docker')
      vm.RemoteCommand('sudo docker run --name test ubuntu')
      vm.RemoteCommand('sudo apt-get update')
      vm.RemoteCommand('sudo apt-get install git')
